...
greenCode.animation = greenCode.kernel:NewLibrary("Animation");
greenCode.animation.sequences = {};
greenCode.animation.override = {};
greenCode.animation.models = {};
greenCode.animation.stored = {};
greenCode.animation.convert = {
...
greenCode.animation.stored.combineOverwatch = {
...
greenCode.animation.stored.civilProtection = {
...
greenCode.animation.stored.femaleHuman = {
	["crouch_grenade_aim_idle"] = ACT_COVER_LOW,
...
greenCode.animation.stored.maleHuman = {
	["crouch_grenade_aim_idle"] = ACT_COVER_LOW,
	["crouch_grenade_aim_walk"] = ACT_WALK_CROUCH,
	["stand_grenade_aim_idle"] = ACT_IDLE,
...
function greenCode.animation:SetMenuSequence(model, sequence)
	self.sequences[string.lower(model)] = sequence;
end;

-- A function to get a model's menu sequence.
function greenCode.animation:GetMenuSequence(model, bRandom)
...
function greenCode.animation:AddModel(class, model)
	local lowerModel = string.lower(model);
...
function greenCode.animation:AddOverride(model, key, value)
	local lowerModel = string.lower(model);
...
function greenCode.animation:GetForModel(model, key)
	if (!model) then
		debug.Trace();
...
function greenCode.animation:GetModelClass(model, alwaysReal)
...
function greenCode.animation:GetTable(model)
	local lowerModel = string.lower(model);
...
greenCode.animation:AddCombineOverwatchModel("models/combine_soldier_prisonguard.mdl");
greenCode.animation:AddCombineOverwatchModel("models/combine_super_soldier.mdl");
greenCode.animation:AddCombineOverwatchModel("models/combine_soldier.mdl");

greenCode.animation:AddCivilProtectionModel("models/police.mdl");

greenCode.animation:AddFemaleHumanModel("models/humans/group01/female_01.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group01/female_02.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group01/female_03.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group01/female_04.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group01/female_06.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group01/female_07.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group02/female_01.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group02/female_02.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group02/female_03.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group02/female_04.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group02/female_06.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group02/female_07.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03/female_01.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03/female_02.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03/female_03.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03/female_04.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03/female_06.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03/female_07.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03m/female_01.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03m/female_02.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03m/female_03.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03m/female_04.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03m/female_06.mdl");
greenCode.animation:AddFemaleHumanModel("models/humans/group03m/female_07.mdl");
  
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_01.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_02.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_03.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_04.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_05.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_06.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_07.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_08.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group01/male_09.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_01.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_02.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_03.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_04.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_05.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_06.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_07.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_08.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group02/male_09.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_01.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_02.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_03.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_04.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_05.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_06.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_07.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_08.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03/male_09.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_01.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_02.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_03.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_04.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_05.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_06.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_07.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_08.mdl");
greenCode.animation:AddMaleHumanModel("models/humans/group03m/male_09.mdl");